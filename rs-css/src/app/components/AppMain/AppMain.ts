...
export default class AppMain {
  ...
  htmlViewer: HTMLElement = document.createElement("div");
  ...
  private createForm(): HTMLElement {
    ...
    this.form.append(this.formInput, this.formBtnEnter, this.formBtnHelp);
  ...
  createPhoneSection(): HTMLElement {
    ...
    const paneHeader = createTextElement("p", "pane__title", "CSS Editor style.css");
    ...
    const layoutHeader = createTextElement("p", "layout__title", "HTML Viewer table.html");
